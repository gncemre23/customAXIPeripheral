...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {gpo_0[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {gpo_0[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {gpo_0[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {gpo_0[3]}];  # "LD3"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {din_0}];  # "BTNC"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {gpi_0[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {gpi_0[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {gpi_0[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {gpi_0[3]}];  # "SW3"
